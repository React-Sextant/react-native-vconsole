...
class Network extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    return nextState.requestIds.length !== this.state.requestIds.length || nextState.showingId || this.state.showingId
  }
