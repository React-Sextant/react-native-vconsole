      ...
      <View style={styles.panelHeader}>
        {PANELS.map(type => (
          <TouchableOpacity
            ...
            style={[styles.panelHeaderItem, type === this.state.currentPanelTab && styles.activeTab]}
          >
  ...
  renderPanel() {
    ...
    return (
      <View style={styles.panel}>
        ...
        <View style={styles.panelContent}>{panels[this.state.currentPanelTab || 'Log'] || panels.Empty}</View>
